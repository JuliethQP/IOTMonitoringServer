...
ALLOWED_HOSTS = ["localhost", "44.200.226.142"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.236.237.206",  # Dirección IP de la base de datos
...
TOPIC = "colombia/antioquia/rionegro/admin2/out"
